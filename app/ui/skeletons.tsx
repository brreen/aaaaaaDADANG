    ...
    <div className="flex w-full flex-col md:col-span-4 animate-pulse">
      ...
      <div className="flex grow flex-col justify-between rounded-xl bg-gray-50 p-4">
        ...
        <div className="flex items-center pb-2 pt-6">
          ...
          <div className="ml-2 h-3 w-32 bg-gray-200 rounded" />
        </div>
      </div>
    </div>
  );
...
export function ProductTableSkeleton() {
  return (
    <main className="p-6">
      <div className="h-10 w-48 mb-6 bg-gray-200 rounded animate-pulse" />

      <div className="overflow-x-auto">
        <table className="min-w-full border border-gray-300">
          <thead className="bg-gray-100">
            <tr>
              {['ID Produk', 'Nama Produk', 'Harga', 'Stok', 'Foto', 'Deskripsi'].map((header, idx) => (
